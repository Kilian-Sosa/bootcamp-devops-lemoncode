...
# Security group is created separately from the VPC module/network resources.
# We use the modern aws_vpc_security_group_ingress_rule / egress_rule resources
# (no deprecated aws_security_group_rule, no inline ingress/egress blocks).
